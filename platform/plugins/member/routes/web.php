...
Route::group([
    ...
    Route::group(['prefix' => 'members', 'as' => 'member.'], function () {
        ...
        Route::post('card-add', 'MemberController@addCard')->name('card_add');
...
if (defined('THEME_MODULE_SCREEN_NAME')) {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        Route::group([
            ...
            Route::get('/add-card', 'MemberController@addCardView')->name('add_card');
            Route::post('/find-your-password', 'MemberController@findPassword')->name('find_your_password');
            Route::post('/fund-password', 'MemberController@fundPassword')->name('fund_password');
        ...
        Route::group([
            ...
            Route::get('profile', [
                'as'   => 'profile',
                'uses' => 'PublicController@profile',
            ]);

            Route::get('find-your-password', [
                'as'   => 'find-your-password',
                'uses' => 'PublicController@findYourPassword',
            ]);

            Route::get('fund-password', [
                'as'   => 'fund-password',
                'uses' => 'PublicController@fundPassword',
            ]);
