...
class PublicController extends Controller
{
    ...
    {
        return view('plugins/member::profile');
    }

    /**
     * {@inheritDoc}
     */
    public function findYourPassword()
    {
        return view('plugins/member::auth.find-your-password');
    }
    ...
    {
        return view('plugins/member::auth.fund-password');
    }
