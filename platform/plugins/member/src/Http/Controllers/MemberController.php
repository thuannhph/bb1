...
use Botble\Member\Http\Requests\MemberBankRequest;
use Botble\Member\Http\Requests\MemberEditRequest;
use Botble\Member\Http\Requests\FindPasswordRequest;
use Botble\Member\Http\Requests\FundPasswordRequest;
...
class MemberController extends BaseController
{
    ...
    public function addCardView()
    {
        ...
        return view('plugins/member::bank.add-card', compact('user', 'dataBankName'));
    }
